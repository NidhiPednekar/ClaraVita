...
import 'womens_section.dart'; // Import the WomensSection screen
          ...
          : Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color(0xFFD6A4E8), Colors.white],
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Women's Wellbeing Card
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const WomensSection(),
                            ),
                          );
                        },
                        child: Container(
                              ...
                              const Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 5),
                                    Text(
                                      'Resources designed for women\'s mental health',
                                      style: TextStyle(
                                        color: Colors.white,
                                      ),
                                    ),
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: const Color(0xFFD6A4E8).withOpacity(0.2),
                                  shape: BoxShape.circle,
                                ),
                                child: Icon(
                                  Icons.mood,
